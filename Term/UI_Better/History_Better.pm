package Term::UI_Better::History_Better;
$Term::UI_Better::History_Better::VERSION = '0.50';
...
Term::UI_Better::History_Better - history function

=head1 SYNOPSIS

    use Term::UI_Better::History_Better qw[history];

    history("Some message");

    ### retrieve the history in printable form
    $hist  = Term::UI_Better::History_Better->history_as_string;

    ### redirect output
    local $Term::UI_Better::History_Better::HISTORY_FH = \*STDERR;

=head1 DESCRIPTION

This module provides the C<history> function for C<Term::UI_Better>,
printing and saving all the C<UI> interaction.

Refer to the C<Term::UI_Better> manpage for details on usage from
C<Term::UI_Better>.
...

{
    ...
    sub history {
        ...
        local $| = 1;
        my $old_fh = select $Term::UI_Better::History_Better::HISTORY_FH;
...
C<Log::Message::Simple>, C<Term::UI_Better>
